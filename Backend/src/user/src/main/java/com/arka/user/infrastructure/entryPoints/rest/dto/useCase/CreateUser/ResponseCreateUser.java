...
public class ResponseCreateUser {
    ...
    public static ResponseCreateUser createFromModel(User model, String msg){
        return ResponseCreateUser.builder()
            .id(model.getId())
            .firstName(model.getName().getFirstName())
            .lastName(model.getName().getLastName())
            .firstSurname(model.getName().getFirstSurname())
            .lastSurname(model.getName().getLastSurname())
