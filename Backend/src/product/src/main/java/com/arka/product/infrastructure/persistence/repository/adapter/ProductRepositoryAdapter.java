...
import com.arka.product.infrastructure.persistence.repository.gateway.IJPAProductRepository;
...
public class ProductRepositoryAdapter implements IProductRepositoryPort{
    ...
    private final ProductHistoryRespositoryAdapter productHistoryAdapter;
    ...
    public Product save(Product product) {
        ...
        productHistoryAdapter.save(savedEntity);
        Product savedModel = persistanceMapper.toDomain(nProduct);
        return savedModel;
    }
